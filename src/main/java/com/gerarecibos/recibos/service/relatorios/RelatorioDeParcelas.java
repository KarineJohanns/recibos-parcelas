...
import com.gerarecibos.recibos.report.ParcelaReportGenerator;
...
@Service
public class RelatorioDeParcelas {
    ...
    public byte[] gerarRelatorioPdf(RelatorioRequestDTO request) throws IOException {
        ...
        ParcelaReportGenerator reportGenerator = new ParcelaReportGenerator(parcelas, totais);
